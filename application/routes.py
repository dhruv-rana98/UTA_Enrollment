...
def enrollment():
    ...
    return render_template("enrollment.html", enrollemnt=True, data={"id":id, "title":title, "term":term})
...
@app.route("/user")
def user():
    # User(user_id=1, first_name="Christian", last_name="Hur", email="christian@gmail.com",password="abc1234").save()
    # User(user_id=2, first_name="Mary", last_name="Jane", email="mary.jane@utu.com",password="password123").save()
